<script lang="ts">
  ...
  const archives = [
    ...
    { name: 'Canuckle', href: '/canuckle-archive', description: 'Canuckle answer history with puzzle numbers, dates, and facts', color: 'from-rose-500 to-red-600', icon: 'Ca' },
    { name: 'Quordle', href: '/quordle-archive', description: 'All four-word puzzle solutions', color: 'from-blue-500 to-indigo-600', icon: 'Qd' },
    { name: 'Colorfle', href: '/colorfle-archive', description: 'Daily mixed color answer history', color: 'from-fuchsia-500 to-pink-600', icon: 'Cf' },
    { name: 'Colordle', href: '/colordle-archive', description: 'Complete daily color answer history', color: 'from-indigo-500 to-purple-600', icon: 'Cd' },
    { name: 'Countryle', href: '/countryle-archive', description: 'Past country answers with saved stats', color: 'from-teal-500 to-teal-600', icon: 'Cy' },
    { name: 'Framed', href: '/framed-archive', description: 'Past Framed movie titles by date', color: 'from-amber-500 to-orange-600', icon: 'Fr' },
    { name: 'Semantle', href: '/semantle-archive', description: 'Every secret word since launch', color: 'from-purple-500 to-violet-600', icon: 'Sm' },
    { name: 'Phoodle', href: '/phoodle-archive', description: 'All food word puzzle solutions', color: 'from-orange-500 to-amber-600', icon: 'Ph' },
    { name: 'Globle', href: '/globle-archive', description: 'Daily country answers since 2022', color: 'from-sky-500 to-cyan-600', icon: 'Gb' },
    { name: 'Waffle', href: '/waffle-archive', description: 'Complete waffle grid puzzle history', color: 'from-amber-500 to-orange-600', icon: 'Wf' },
    { name: 'Worldle', href: '/worldle-archive', description: 'Country silhouette answers by date', color: 'from-sky-600 to-blue-700', icon: 'WL' },
    { name: 'Nerdle', href: '/nerdle-archive', description: 'Math equation answer history and puzzle dates', color: 'from-teal-500 to-teal-600', icon: 'Nd' },
    { name: 'Searchle', href: '/searchle-archive', description: 'Autocomplete puzzle answers and prompts', color: 'from-purple-500 to-pink-600', icon: 'Sr' },
    { name: 'Contexto', href: '/contexto-archive', description: 'Semantic answer words and game dates', color: 'from-violet-500 to-fuchsia-600', icon: 'Cx' },
...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
  ...
  <article class="mt-16">
    <div class="prose prose-slate dark:prose-invert max-w-none prose-headings:scroll-mt-20">
      ...
      <h2 class="text-slate-900 dark:text-slate-50">Why Puzzle Archives Matter</h2>
