...
<svelte:head>
  ...
  <meta name="description" content="Advanced solver tools for Wordle, Quordle, Phoodle, Waffle, Colordle and more. Get unstuck with smart word filtering and elimination." />
