...
<GameDleSolverPage gameKey="dotadle" />

<section class="max-w-4xl mx-auto px-4 py-16">
  <div class="space-y-10">

    <article class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8">
      <h2 class="text-2xl font-bold text-slate-900 mb-4">What Makes Dotadle Different From Other Character Guessing Games</h2>
    ...
    <article class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8">
      <h2 class="text-2xl font-bold text-slate-900 mb-4">Dotadle Solving Strategy: A Step-by-Step Approach</h2>
      <p class="text-slate-600 mb-4 leading-relaxed">
    ...
    <article class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8">
      <h2 class="text-2xl font-bold text-slate-900 mb-4">Dotadle Attributes That Trip Up Even Veteran Dota Players</h2>
      <p class="text-slate-600 mb-4 leading-relaxed">
    ...
    <article class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8">
      <h2 class="text-2xl font-bold text-slate-900 mb-4">Dotadle as a Gateway to Understanding Dota 2</h2>
      <p class="text-slate-600 mb-4 leading-relaxed">
