...
<main class="min-h-screen bg-slate-50 py-8 dark:bg-slate-950">
  ...
  <section class="mx-auto mt-6 max-w-5xl px-4 sm:px-6 lg:px-8">
    <BetweenleSolverClient />
  </section>

  <section class="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 space-y-10">
    <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-slate-900">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-5">What is Betweenle?</h2>
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-slate-900">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-5">Why Alphabetical Ordering Is Harder Than Letter Matching</h2>
      <p class="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-slate-900">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-5">How Our Betweenle Solver Works</h2>
      <p class="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
    ...
    <section class="rounded-3xl border border-slate-200 bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-950 p-8 shadow-lg">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-5">The Hotter/Colder Indicator Explained</h2>
      <p class="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-slate-900">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-5">Tips for Narrowing the Range Fast</h2>
      <div class="space-y-5">
        <div class="flex gap-4">
          ...
          <div>
            <h3 class="font-bold text-slate-900 dark:text-white">Guess words near the middle of the alphabet</h3>
            <p class="text-slate-600 dark:text-slate-400 mt-1 text-sm">Words starting with L, M, or N split the common English word list roughly in half. "MOUNT," "LEVEL," or "NIGHT" are strong openers because they divide the range into near-equal halves.</p>
          </div>
        </div>
        <div class="flex gap-4">
          ...
          <div>
            <h3 class="font-bold text-slate-900 dark:text-white">Pay attention to the percentage more than the direction</h3>
            <p class="text-slate-600 dark:text-slate-400 mt-1 text-sm">"After" tells you which half the answer is in. The percentage tells you where in that half. A 95% reading is much more informative than the direction alone — it means the answer is right next to one of your boundaries.</p>
          </div>
        </div>
        <div class="flex gap-4">
          ...
          <div>
            <h3 class="font-bold text-slate-900 dark:text-white">When the range is small, list the words mentally</h3>
            <p class="text-slate-600 dark:text-slate-400 mt-1 text-sm">If your bounds are "CRANE" and "CREAM," the answer is one of maybe 10-15 words starting with CRA or CRE. The solver shows you these candidates directly, but even without it, you can mentally enumerate: CRANE, CRASH, CRAVE, CRAWL, CREAM...</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-slate-900">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-5">Best Opening Words for Betweenle</h2>
      <p class="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
      ...
      <div class="grid gap-3 md:grid-cols-3 mb-4">
        <div class="rounded-xl bg-indigo-50 dark:bg-indigo-900/20 p-4 text-center">
          <p class="text-lg font-bold text-indigo-700 dark:text-indigo-300">MOUNT</p>
          <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Near the M midpoint</p>
        </div>
        <div class="rounded-xl bg-purple-50 dark:bg-purple-900/20 p-4 text-center">
          <p class="text-lg font-bold text-purple-700 dark:text-purple-300">LEVEL</p>
          <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">L-range with common letters</p>
        </div>
        <div class="rounded-xl bg-fuchsia-50 dark:bg-fuchsia-900/20 p-4 text-center">
          <p class="text-lg font-bold text-fuchsia-700 dark:text-fuchsia-300">NIGHT</p>
          <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">N-range, slightly above center</p>
        </div>
      </div>
      <p class="text-slate-600 dark:text-slate-300 leading-relaxed">
    ...
    <section class="rounded-3xl bg-slate-100 dark:bg-slate-900 p-8 text-center space-y-6">
      ...
      <div class="flex flex-wrap justify-center gap-3">
        <a href="/5-letter-wordle-solver" class="px-5 py-2.5 bg-white dark:bg-slate-800 rounded-xl font-semibold text-slate-700 dark:text-slate-200 shadow-sm hover:shadow-md transition-shadow">5-Letter Wordle Solver</a>
        <a href="/phoodle-solver" class="px-5 py-2.5 bg-white dark:bg-slate-800 rounded-xl font-semibold text-slate-700 dark:text-slate-200 shadow-sm hover:shadow-md transition-shadow">Phoodle Solver</a>
        <a href="/waffle-solver" class="px-5 py-2.5 bg-white dark:bg-slate-800 rounded-xl font-semibold text-slate-700 dark:text-slate-200 shadow-sm hover:shadow-md transition-shadow">Waffle Solver</a>
        <a href="/searchle-solver" class="px-5 py-2.5 bg-white dark:bg-slate-800 rounded-xl font-semibold text-slate-700 dark:text-slate-200 shadow-sm hover:shadow-md transition-shadow">Searchle Solver</a>
      </div>
    </section>
  </section>
</main>
