  ...
  <main class="max-w-5xl mx-auto px-4 py-8">
    ...
    <article class="mx-auto max-w-5xl px-4 pb-12 space-y-8">
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p class="mt-4 text-lg leading-8 text-slate-600">
          Each day, Searchle selects one puzzle from its dataset of {totalPuzzles.toLocaleString('en-US')} entries. The puzzle consists of a Google search prompt — a partial sentence or question with a blank where the autocomplete word goes. Your job is to type the word that completes the prompt. The prompt for today ({todayLabel}) is shown above, and you can reveal the answer using the answer card.
        </p>
        <p class="mt-4 text-lg leading-8 text-slate-600">
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p class="mt-4 text-lg leading-8 text-slate-600">
          For previous days, visit the Searchle archive. The archive contains all {totalPuzzles.toLocaleString('en-US')} puzzles with their prompts and answers, searchable by date. Spending 10 minutes browsing past puzzles is one of the fastest ways to improve at Searchle because you start recognizing the types of prompts and answers the game uses.
        </p>
      </section>
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div class="mt-6 space-y-6">
          ...
          <div class="rounded-2xl bg-slate-50 p-6">
            ...
            <p class="mt-2 text-base leading-7 text-slate-600">
              The Searchle archive has {totalPuzzles.toLocaleString('en-US')} puzzles you can browse by date. Scanning through a week of past answers teaches you which words Google autocomplete favors — common verbs like MAKE, GET, FIX, and FIND appear disproportionately often. The archive is the best study tool for improving your Searchle performance.
            </p>
          </div>
          <div class="rounded-2xl bg-slate-50 p-6">
