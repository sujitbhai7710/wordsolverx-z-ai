...
<main class="min-h-screen bg-white">
  ...
  <div class="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 space-y-10">
    <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl dark:border-slate-700 dark:bg-slate-900">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-5">What is Kanoodle?</h2>
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl dark:border-slate-700 dark:bg-slate-900">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-5">Why the L-Piece and T-Piece Cause 80% of Failures</h2>
      <p class="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl dark:border-slate-700 dark:bg-slate-900">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-5">How Our Kanoodle Solver Works</h2>
      <p class="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
    ...
    <section class="rounded-3xl border border-slate-200 bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-950 p-8 shadow-xl">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-5">Tips for Getting Better at Kanoodle</h2>
      <div class="space-y-5">
        <div class="flex gap-4">
          ...
          <div>
            <h3 class="font-bold text-slate-900 dark:text-white">Place big pieces first</h3>
            <p class="text-slate-600 dark:text-slate-400 mt-1 text-sm">The 4- and 5-cell pieces have fewer valid positions. Place them while the board is mostly empty. Save the 1- and 2-cell pieces for last — they fit almost anywhere.</p>
          </div>
        </div>
        <div class="flex gap-4">
          <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-sky-100 text-sky-700 font-bold flex items-center justify-center">2</span>
          <div>
            <h3 class="font-bold text-slate-900 dark:text-white">Fill corners early</h3>
            <p class="text-slate-600 dark:text-slate-400 mt-1 text-sm">Corners have only one cell. Pieces that can fill a corner and extend along an edge are prime candidates for early placement. Once the corners are locked, the rest flows more easily.</p>
          </div>
        </div>
        <div class="flex gap-4">
          ...
          <div>
            <h3 class="font-bold text-slate-900 dark:text-white">Use Check before you commit</h3>
            <p class="text-slate-600 dark:text-slate-400 mt-1 text-sm">After placing 3-4 pieces, hit Check. If the board is unsolvable, undo the last piece instead of wasting time on a dead path. This single habit cuts your solve time dramatically.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl dark:border-slate-700 dark:bg-slate-900">
      <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-5">Kanoodle vs Kanoodle Genius vs Kanoodle Extreme</h2>
      <div class="grid gap-4 md:grid-cols-3">
        <div class="rounded-xl bg-slate-50 dark:bg-slate-800 p-5">
          <h3 class="font-bold text-slate-900 dark:text-white mb-2">Kanoodle</h3>
          <p class="text-sm text-slate-600 dark:text-slate-400">Original game. 12 pieces, 5x11 board, 2D only. The version this solver handles. Good for ages 7 and up.</p>
        </div>
        <div class="rounded-xl bg-slate-50 dark:bg-slate-800 p-5">
          <h3 class="font-bold text-slate-900 dark:text-white mb-2">Kanoodle Genius</h3>
          <p class="text-sm text-slate-600 dark:text-slate-400">Same pieces, but adds a 3D pyramid building mode on top of the flat board. The 2D puzzles are harder than the original.</p>
        </div>
        <div class="rounded-xl bg-slate-50 dark:bg-slate-800 p-5">
          <h3 class="font-bold text-slate-900 dark:text-white mb-2">Kanoodle Extreme</h3>
          <p class="text-sm text-slate-600 dark:text-slate-400">Adds a sliding puzzle element. The board has a sliding piece that changes the available space. This solver doesn't handle that variant yet.</p>
        </div>
      </div>
    </section>

    <div class="rounded-3xl border border-slate-200 bg-white p-2 shadow-xl dark:border-slate-700 dark:bg-slate-900">
      <FAQSection class="py-0" {faqs} title="Kanoodle Solver FAQs" />
    </div>
    ...
    <section class="rounded-3xl bg-slate-100 dark:bg-slate-900 p-8 text-center space-y-6">
      ...
      <div class="flex flex-wrap justify-center gap-3">
        <a href="/light-out-solver" class="px-5 py-2.5 bg-white dark:bg-slate-800 rounded-xl font-semibold text-slate-700 dark:text-slate-200 shadow-sm hover:shadow-md transition-shadow">Light Out Solver</a>
        <a href="/minesweeper-solver" class="px-5 py-2.5 bg-white dark:bg-slate-800 rounded-xl font-semibold text-slate-700 dark:text-slate-200 shadow-sm hover:shadow-md transition-shadow">Minesweeper Solver</a>
        <a href="/boggle-solver" class="px-5 py-2.5 bg-white dark:bg-slate-800 rounded-xl font-semibold text-slate-700 dark:text-slate-200 shadow-sm hover:shadow-md transition-shadow">Boggle Solver</a>
      </div>
    </section>
  </div>
</main>
