  ...
  <div class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div class="mx-auto mt-10 flex items-center justify-center gap-4 sm:gap-6">
        {#each data.answer.colors as color}
          <div class="flex flex-col items-center gap-2">
            <div
              class="h-16 w-16 rounded-xl shadow-lg ring-[3px] ring-teal-500 sm:h-20 sm:w-20"
    ...
    <article class="mt-8 space-y-8">
      <section class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p class="mt-4 text-lg leading-8 text-slate-600">
          The game launched in 2022 during the wave of daily puzzle spinoffs that followed Wordle&apos;s explosion in popularity. While most of those clones stuck to words, Colorfle carved out a niche by focusing on color perception. It sits in the same category as games like Colordle and Contexto — puzzles that test a type of intelligence that traditional word games ignore entirely.
        </p>
        <p class="mt-4 text-lg leading-8 text-slate-600">
          The player base is smaller than Wordle&apos;s but noticeably dedicated. Color players tend to be designers, artists, photographers, and front-end developers — people who work with color every day and enjoy having their perception tested. The game has maintained consistent daily engagement because color perception is a genuine skill that improves with practice, and the daily format provides regular training.
        </p>
      </section>
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p class="mt-4 text-lg leading-8 text-slate-600">
          Each Colorfle puzzle presents a single target color — the exact hex code and RGB values that make up the answer. Your task is to figure out which three colors mix to create that target. The component colors are drawn from a curated palette of named colors, and each carries a weight percentage indicating how much it contributes to the final mix.
        </p>
        <p class="mt-4 text-lg leading-8 text-slate-600">
          The daily cycle resets at midnight in the game&apos;s local timezone. Each puzzle is assigned a sequential number, so puzzle #{data.answer.puzzleNumber} follows #{data.answer.puzzleNumber - 1} from the day before. This page displays the target color as a blurred circle until you click to reveal it, giving you a chance to think about the answer before seeing it.
        </p>
        <p class="mt-4 text-lg leading-8 text-slate-600">
          Color mixing in Colorfle uses an additive RGB model. When you see a target like a muted olive green, the component colors might include something like 50% yellow-green, 30% dark brown, and 20% pale yellow. The exact proportions matter — a small shift in one component color can push the target noticeably toward a different hue family.
        </p>
        <p class="mt-4 text-lg leading-8 text-slate-600">
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p class="mt-4 text-lg leading-8 text-slate-600">
          The answer section above shows the target color, its hex code, and the three component colors with their individual weights. The weight tells you what percentage of the final mix each component represents. If one color carries 60% weight, it dominates the target — you should see that color&apos;s hue clearly in the result.
        </p>
        <p class="mt-4 text-lg leading-8 text-slate-600">
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div class="mt-6 space-y-6">
          ...
          <div class="rounded-2xl bg-slate-50 p-6">
            ...
            <p class="mt-2 text-base leading-7 text-slate-600">
              Color perception has three dimensions: hue, saturation, and brightness. The hue tells you the color family (red, blue, etc.), saturation tells you how vivid it is, and brightness tells you how light or dark. One component might control the hue while another adjusts the saturation. A bright, vivid target needs different treatment than a muted, pastel one.
            </p>
          </div>
          <div class="rounded-2xl bg-slate-50 p-6">
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div class="mt-6 grid gap-6 sm:grid-cols-2">
          <div class="rounded-2xl bg-slate-50 p-6">
            ...
            <p class="mt-2 text-base leading-7 text-slate-600">
              Colordle shows you a target color and you guess its name — it is about naming precision. Colorfle shows you a target color and you identify the component colors that create it — it is about understanding how colors mix. Colordle tests vocabulary; Colorfle tests perception. Both are daily color games, but they exercise different cognitive skills.
            </p>
          </div>
          <div class="rounded-2xl bg-slate-50 p-6">
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div class="mt-6 space-y-6">
          <div class="rounded-2xl bg-slate-50 p-6">
            ...
            <p class="mt-2 text-base leading-7 text-slate-600">
              Colorfle uses an additive RGB mixing model, which is how screens produce color. Red, green, and blue light combine to create white. This is different from subtractive mixing (paint), where combining all primary colors produces dark brown or black. If you are thinking about Colorfle in terms of paint, your instincts will lead you astray. Think in terms of light and screens instead — the results will make much more sense.
            </p>
          </div>
          <div class="rounded-2xl bg-slate-50 p-6">
            <h3 class="text-lg font-bold text-slate-900">The Role of White and Black</h3>
            <p class="mt-2 text-base leading-7 text-slate-600">
              White lightens a color (raises brightness) while darkening or desaturating a color often involves mixing in a darker component. In the Colorfle palette, white and near-white colors are critical for producing pastels. If the target looks pastel — soft pink, pale blue, mint green — one of your three components is almost certainly a light or white color. If the target looks dark and rich, expect darker components like dark slate or navy.
            </p>
          </div>
          <div class="rounded-2xl bg-slate-50 p-6">
            <h3 class="text-lg font-bold text-slate-900">Weight Changes Everything</h3>
            <p class="mt-2 text-base leading-7 text-slate-600">
              Three colors with equal 33% weights produce a neutral average. Three colors with 70/20/10 weights produce something that looks almost entirely like the dominant color with subtle undertones. Pay close attention to how much each component contributes — the same three colors can produce wildly different results depending on the weight distribution. A small shift in one weight can push the target across a hue boundary.
            </p>
          </div>
          <div class="rounded-2xl bg-slate-50 p-6">
            <h3 class="text-lg font-bold text-slate-900">Common Colorfle Patterns</h3>
            <p class="mt-2 text-base leading-7 text-slate-600">
              After playing Colorfle for a few weeks, you start noticing recurring patterns. Muted greens often come from mixing a bright green with a gray or brown. Warm beiges typically combine yellow, light brown, and white. Dusty roses pair pink with a touch of gray or purple. These patterns are not rules, but they are reliable heuristics that speed up your solving process significantly.
            </p>
          </div>
        </div>
      </section>
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div class="mt-6 space-y-6">
          <div>
            ...
            <p class="mt-2 text-base leading-7 text-slate-600">
              Colorfle resets at midnight based on the game&apos;s server timezone. Each puzzle carries a sequential number, so puzzle #{data.answer.puzzleNumber} follows #{data.answer.puzzleNumber - 1}. The exact reset time depends on where the Colorfle servers are hosted, but the puzzle number makes it easy to verify you are looking at the correct day&apos;s answer.
            </p>
          </div>
          <div>
            <h3 class="text-lg font-bold text-slate-900">How many guesses do I get in Colorfle?</h3>
            <p class="mt-2 text-base leading-7 text-slate-600">
              There is no strict guess limit in Colorfle. You can submit component combinations until you find the exact match or decide to reveal the answer. Most players solve the puzzle in three to five attempts once they understand the mixing system. The challenge is not the guess count — it is identifying the right combination of colors and weights.
            </p>
          </div>
          <div>
            <h3 class="text-lg font-bold text-slate-900">Where does Colorfle get its color palette?</h3>
            <p class="mt-2 text-base leading-7 text-slate-600">
              Colorfle draws component colors from a curated set of named CSS colors — the same standardized palette that web browsers recognize. Colors like DarkKhaki, CadetBlue, IndianRed, and Coral are all part of this set. There are roughly 150 named colors in the CSS specification, and Colorfle uses a subset of them as its component pool. Learning this palette is one of the fastest ways to improve at the game.
            </p>
          </div>
          <div>
            <h3 class="text-lg font-bold text-slate-900">Can I use a color picker to solve Colorfle?</h3>
            <p class="mt-2 text-base leading-7 text-slate-600">
              Technically yes — you could sample the target color with a digital color picker and reverse-engineer the components. But that defeats the purpose. The game is about training your eye and building color intuition, not about using tools to bypass the challenge. If you want the answer without solving, this page provides it directly.
            </p>
          </div>
          <div>
            <h3 class="text-lg font-bold text-slate-900">Does Colorfle improve real-world color skills?</h3>
            <p class="mt-2 text-base leading-7 text-slate-600">
              Absolutely. Regular Colorfle play measurably improves your ability to identify hues, judge saturation levels, and estimate color mixing outcomes. Designers and front-end developers who play daily report that they pick better palettes and spot color mismatches faster. Even casual players develop a sharper eye for the colors around them — from sunsets to store displays to the paint section at the hardware store.
            </p>
          </div>
        </div>
      </section>
