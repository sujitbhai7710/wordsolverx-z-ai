...
<GameDleSolverPage gameKey="loldle" />

<section class="max-w-4xl mx-auto px-4 py-16">
  <div class="space-y-10">

    <article class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8">
      <h2 class="text-2xl font-bold text-slate-900 mb-4">Understanding the Loldle Attribute System</h2>
    ...
    <article class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8">
      <h2 class="text-2xl font-bold text-slate-900 mb-4">Advanced Loldle Solving Strategies That Actually Work</h2>
      <p class="text-slate-600 mb-4 leading-relaxed">
    ...
    <article class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8">
      <h2 class="text-2xl font-bold text-slate-900 mb-4">Loldle Compared to Other Character Guessing Games</h2>
      <p class="text-slate-600 mb-4 leading-relaxed">
    ...
    <article class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8">
      <h2 class="text-2xl font-bold text-slate-900 mb-4">Building Loldle Intuition Over Time</h2>
      <p class="text-slate-600 mb-4 leading-relaxed">
