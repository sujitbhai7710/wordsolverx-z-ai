...
(function() {
     ...
     * @param {boolean} use_limit_nyt
     * @param {number} word_length
     * @returns {any}
     */
    __exports.compute = function(state, hard_mode, use_limit_nyt, word_length) {
        const ptr0 = passStringToWasm0(state, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.compute(ptr0, len0, hard_mode, use_limit_nyt, word_length);
        return ret;
    };
